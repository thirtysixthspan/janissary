...
Attaching a harness redraws its retained terminal output and restores its recent transcript history without waiting for new output. Attaching an agent likewise opens its restored tab with retained shell output already in its transcript. Older history may be trimmed; a notice appears when terminal history was trimmed. Sessions started before display-history retention was available cannot recover output they did not retain.
