...
describe('TabStrip', () => {
  it('renders a tab label', () => {
    ...
    render(<TabStrip tabs={[tab]} activeTab={0} onSelect={vi.fn()} onClose={vi.fn()} onRename={vi.fn()} />);
  ...
  it('marks the active tab with the active class', () => {
    ...
    const { container } = render(
      <TabStrip tabs={tabs} activeTab={1} onSelect={vi.fn()} onClose={vi.fn()} onRename={vi.fn()} />,
    );
  ...
  it('calls onSelect with the tab index when clicked', async () => {
    ...
    const tabs = [makeTab({ label: 'a' }), makeTab({ label: 'b' })];
    render(<TabStrip tabs={tabs} activeTab={0} onSelect={onSelect} onClose={vi.fn()} onRename={vi.fn()} />);
  ...
  it('calls onClose and stops propagation when the close button is clicked', async () => {
    ...
    render(<TabStrip tabs={[tab]} activeTab={0} onSelect={onSelect} onClose={onClose} onRename={vi.fn()} />);
  ...
  it('applies busy class to the dot when tab is busy', () => {
    ...
    const { container } = render(
      <TabStrip tabs={[tab]} activeTab={0} onSelect={vi.fn()} onClose={vi.fn()} onRename={vi.fn()} />,
    );
  ...
  it('shows the unread badge when hasUnread is set', () => {
    const { container } = render(
      <TabStrip tabs={[makeTab({ hasUnread: true })]} activeTab={0} onSelect={vi.fn()} onClose={vi.fn()} onRename={vi.fn()} />,
    );
  ...
  it('shows no badge when hasUnread is false', () => {
    const { container } = render(
      <TabStrip tabs={[makeTab({ hasUnread: false })]} activeTab={0} onSelect={vi.fn()} onClose={vi.fn()} onRename={vi.fn()} />,
    );
  ...
  it('commits the trimmed value once on Enter', async () => {
    ...
    const tab = makeTab({ label: 'internal', title: 'Display Name' });
    render(<TabStrip tabs={[tab]} activeTab={0} onSelect={vi.fn()} onClose={vi.fn()} onRename={onRename} />);
    await userEvent.click(screen.getByText('Display Name'));
  ...
  it('commits on blur', async () => {
    ...
    render(
      <>
        <TabStrip tabs={[tab]} activeTab={0} onSelect={vi.fn()} onClose={vi.fn()} onRename={onRename} />
