...
export function ReportingSection({ entries, onClose, onRun, onRate, onReset, onSnapshot }: {
  ...
  return (
    <div className="reporting-section" style={{ flex: `0 0 ${heightPct}%` }}>
      ...
      {current.tab.view === 'monitor' && current.tab.monitor && (
        <div className="reporting-body" tabIndex={0} style={{ borderLeft: `4px solid ${current.tab.dotColor}` }}>
          <MonitorTab
