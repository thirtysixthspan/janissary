...
type Properties = { ptyId: string; client: JanusClient };
...
export const ShellTab = forwardRef<ShellTabHandle, Properties>(function ShellTab({ ptyId, client }, ref) {
  ...
  return <div className="harness-tab"><div className="harness-body" ref={hostReference} /></div>;
});
