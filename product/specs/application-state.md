...
Only agent tabs are persisted and restored this way. View tabs — image, page, markdown, editor, file tree, monitor, and notifications (see `tabs.md`) — are live, in-memory views that are never saved and never recreated on `--relaunch`.
