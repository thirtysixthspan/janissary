...
The active agent or harness entry is saved with `tab.focus: true`; other captured main-area entries omit it, so relaunching returns to the same tab. Editor tabs remain launch-only and are skipped during capture.
