...
| `syncPaths` | `string[]` | `[]` | Project-relative file paths kept automatically synced with GitHub (see `editor-tab.md` → "GitHub syncing"). There is no runtime command to change this — the user edits `.janissary/config.json` directly. |
