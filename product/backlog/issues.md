...
* when a browser is started and attached to a harness, the harness should indicate it in the metadata bar with an appropriate icon, similar to and located next to the workspace and auto approve icons.
