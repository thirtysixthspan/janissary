...
* profiles should be able to specify the size of the application window, the sidebars, and upper and lower tab areas.

* Build a Profile gallery in documentation  
