...
`Ctrl+G` opens a window listing every open tab — agent, harness, SSH, viewer, and reporting tabs alike — floating above the command bar, in the same spot the [history picker](/command-bar/history) appears.
