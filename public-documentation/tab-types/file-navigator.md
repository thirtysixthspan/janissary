...
it back to center and focuses it. See [Tabs](/getting-started/tabs) for more on sidebars.

The sidebars are shared with the [notifications](/tab-types/notifications) feed, which docks the
