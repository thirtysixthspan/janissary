...
* the screenshot in the Docking to a sidebar page of the public documentation should show the entire application, where the file navigator is docked to the left hand side of the application.
