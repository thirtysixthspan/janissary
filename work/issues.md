...
* When in the editor tab, shift arrow left and right should switch tabs.

* when opening a file in a new editor tab, the editor tab should get focus, and keyboard focus should be on the first line.
