...
export type TabView = {
  ...
  hasUnread: boolean;
  cwd: string;
  // Display form of `cwd` for a workspaced tab's metadata row: the clone root reads as
  // `$workspace/<name>` and anything inside it as `$workspace/<name>/<rest>`, local and remote
