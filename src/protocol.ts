...
export type RpcCall =
  ...
  // Rename a file or directory in place (same directory) in a file tree tab. `relPath` is the
  // tree-relative path of the row being renamed; `newName` is the bare new filename (no path
  // separators).
