...
describe('frame codec', () => {
  ...
  it('round-trips every client frame', () => {
    const frames: RemoteFrame[] = [
      ...
      { type: 'kill', id: 'r1' },
      { type: 'capture-request', session: '12345678-1234-1234-1234-123456789abc', id: 'r1' },
  ...
  it('round-trips every server frame', () => {
    const frames: RemoteFrame[] = [
      ...
      { type: 'capture-reply', id: 'r1', text: 'the screen text', capturedAt: 1_700_000_000_000 },
      { type: 'capture-reply', id: 'r1' },
