...
// The topic half of the contract lives beside the declared intent table and is re-exported here too,
// so a plugin still reads the whole v1 contract from one module.
export {
