...
export type TabPluginTopicAction =
  ...
  // session that may have no tab at all. Every one is refused when it names something the topic's
  // current data does not hold, the same narrowing `focusOwner` applies.
